 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.splitit.staging
 */

const BUNDLE_ID = 'com.splitit'; // ios bundle id
const PACKAGE = 'com.splitit'; // android package name
const NAME = 'splitit'; // app name
